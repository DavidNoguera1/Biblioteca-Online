                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                <input type="file" class="form-control" id="image" name="image" data-sb-validations="required" />
                                <label for="image">Imagen</label>
                                <div class="invalid-feedback" data-sb-feedback="image required">¡Imagen requerida!</div>
                            </div>
